...
public class Regex {
    public static void main(String[] args) {
        ...
        // Provide the pattern
        pattern = Pattern.compile("(?!.*[bBlL]).{6,}");
        ...
        // First name: Amber Gwenn
        // Student number: 2022-106626
        System.out.print("Enter Email: ");
        String email = scan.nextLine();

        // Provide regex pattern
        pattern = Pattern.compile("^(?=.*2{1})(?=.*6{1})[a-zA-Z0-9_.]+.{10,}(@gmail.com$)");
        ...
        // Name: Amber Gwenn Balboa
        System.out.print("Enter URL: ");
        String url = scan.nextLine();

        // Provide regex pattern
        pattern = Pattern.compile("((http:\/\/(?:www\.|(?!www)))|(?:www\.))(amber)(gwenn)(balboa)(\.com(?:\.[a-z]{2})?)(\/[a-z-.]+)?");
